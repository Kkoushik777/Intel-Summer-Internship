...
int main(int argc, char** argv)
{
	...
	if (testCertificateChecking("bob.crt", "rootCA.crt", "Bob.com") && !testCertificateChecking("bob.crt", "rootCA.crt", "Bob.com") && !testCertificateChecking("bob.crt", "alice.crt", "Bob.com"))
